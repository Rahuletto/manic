...
flowchart TD
  ...
  MN["Parallel oxc-minify client api server.js"]
...
| **11 · Minify** | **JS under client / api + `server.js`** | **`minifySync`**, **`es2022`**, mangle; avoids redundant full-root traversal |
...
- [Bundler standalone guide](/docs/core/bundler-standalone) — reuse `@manicjs/bundler` in your own framework
